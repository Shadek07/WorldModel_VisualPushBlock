...
from constants import SCREEN_Y, SCREEN_X, z_size
...
class Model:
  ...
  def encode_obs(self, obs):
    ...
    result = result.reshape(1, SCREEN_X, SCREEN_Y, 3)
...
def simulate_test(model, train_mode=False, render_mode=True, num_episode=5, seed=-1, max_len=-1):
...
def main():
  ...
  while(1):
    reward, steps_taken = simulate_test(model, train_mode=False, render_mode=render_mode, num_episode=1)
